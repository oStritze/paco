"""
Snippet for creating the PyTorch Models from: https://github.com/IlliaOvcharenko/lung-segmentation
"""
...
class tuned_PretrainedUNet(torch.nn.Module):
    """
    Own U-Net based on VGG11 encoder and transposed upconv instead of interpolation. 
    The design is now very much on par with
        Towards Robust Lung Segmentation https://arxiv.org/abs/1811.12638
    """
